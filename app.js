...
// Here is the test for sumAndMultiply(); uncomment it to run it
 ...
 //eslint-disable-line
    function sumAndMultiply(a, b, c) { //eslint-disable-line
        ...
        let sum0=sum(a,sum(b,c)[0])[0];
        let multi0=multiply(a,multiply(b,c)[0])[0];
        return [sum0,multi0,`${a} and ${b} and ${c} sum to ${sum0}.`,`The product of ${a} and ${b} and ${c} is ${multi0}.`]
    }
    testSumAndMultiply(4,7,5);
...
function sumArray(sumArr) { //eslint-disable-line
    let sumarry1=sum(sumArr[0],sum(sumArr[1],sumArr[2])[0])[0];


    return [sumarry1,`${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sumarry1} is their sum.`];
}
...
function multiplyArray(multArr) { //eslint-disable-line
   ...
   let  fiveelemant = [];
    ...
    finalProduct = finalProduct[0];
     fiveelemant[0] = finalProduct;


   fiveelemant[1] = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${finalProduct}.`
